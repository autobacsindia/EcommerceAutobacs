  ...
  useEffect(() => {
    if (typeof window !== 'undefined' && (window as any).Sentry) {
      (window as any).Sentry.captureException(error, {
        tags: { type: 'route-error', scope: 'admin' },
      ...
      <div className="max-w-lg w-full bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h2 className="text-lg font-semibold text-gray-900 mb-1">Admin panel error</h2>
            <p className="text-sm text-gray-600 mb-4">
              An error occurred while rendering this page. Other sections of the admin panel are unaffected.
            </p>
            ...
            {process.env.NODE_ENV === 'development' && (
              <details className="mt-5">
                ...
                <div className="mt-2 p-3 bg-gray-50 border border-gray-200 rounded text-xs overflow-auto max-h-64">
