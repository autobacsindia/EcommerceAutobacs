    ...
    <div className="min-h-screen bg-obsidian-deep">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-6 space-y-2">
          <div className="h-8 w-48 bg-obsidian-raised animate-pulse rounded" />
          <div className="h-4 w-64 bg-obsidian-raised animate-pulse rounded" />
        </div>
              ...
              <div key={section} className="bg-obsidian rounded-lg p-4 shadow-sm space-y-3">
                ...
                {[1, 2, 3, 4].map((item) => (
                  <div key={item} className="flex items-center gap-2">
                    ...
                    <div className="h-4 bg-obsidian-raised animate-pulse rounded flex-1" />
                  </div>
                ))}
              </div>
            ))}
              ...
              {Array.from({ length: 12 }).map((_, i) => (
                <div key={i} className="bg-obsidian rounded-lg shadow-sm overflow-hidden">
                  ...
                  <div className="p-3 space-y-2">
                    ...
                    <div className="h-8 bg-obsidian-raised animate-pulse rounded mt-2" />
                  </div>
                </div>
              ))}
            </div>
