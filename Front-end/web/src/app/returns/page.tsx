    ...
    <div className="min-h-screen bg-[#080808]">
      ...
      <section className="bg-[#0E0E0E] border-b border-[#252525]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 text-center">
          ...
          <h1 className="text-4xl font-condensed font-bold text-white uppercase tracking-wide mb-4">Return and Exchange Policy</h1>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-[#0E0E0E] border border-[#252525] rounded-sm p-8 space-y-10">

            {/* 1. Return Policy */}
            <div>
              <h2 className="font-condensed font-bold text-white uppercase tracking-wide text-xl mb-4">1. Return Policy</h2>

              <h3 className="font-condensed font-bold text-white uppercase tracking-wide text-sm mb-2">Eligibility for Returns</h3>
              <p className="text-[#C4C4C4] font-body leading-relaxed mb-3">
                You may request a return within <strong className="text-white">7 calendar days</strong> from the date of receiving your order. To be eligible for a return:
              </p>
              <ul className="space-y-1.5 mb-4">
                {[
                  ...
                  <li key={item} className="flex items-start gap-2 text-[#C4C4C4] font-body leading-relaxed">
                    <span className="text-[#3B9EE8] mt-1 shrink-0">—</span><span>{item}</span>
                  </li>
                ))}
              </ul>

              <h3 className="font-condensed font-bold text-white uppercase tracking-wide text-sm mb-2 mt-6">Non-Returnable Items</h3>
              <p className="text-[#C4C4C4] font-body leading-relaxed mb-3">The following items cannot be returned:</p>
              <ul className="space-y-1.5 mb-4">
                {[
                  ...
                  <li key={item} className="flex items-start gap-2 text-[#C4C4C4] font-body leading-relaxed">
                    <span className="text-[#555555] mt-1 shrink-0">—</span><span>{item}</span>
                  </li>
                ))}
              </ul>

              <h3 className="font-condensed font-bold text-white uppercase tracking-wide text-sm mb-2 mt-6">Refund Policy</h3>
              <p className="text-[#C4C4C4] font-body leading-relaxed mb-3">
            ...
            {/* 2. Exchange Policy */}
            <div>
              <h2 className="font-condensed font-bold text-white uppercase tracking-wide text-xl mb-4">2. Exchange Policy</h2>

              <h3 className="font-condensed font-bold text-white uppercase tracking-wide text-sm mb-2">Eligibility for Exchange</h3>
              <p className="text-[#C4C4C4] font-body leading-relaxed mb-3">
                You may request an exchange within <strong className="text-white">7 days</strong> of receiving your order if:
              </p>
              ...
              <h3 className="font-condensed font-bold text-white uppercase tracking-wide text-sm mb-3">Exchange Process</h3>
              <ol className="space-y-3">
                {[
                  ...
                  <li key={step} className="flex items-start gap-4">
                    <span className="shrink-0 w-7 h-7 rounded-full bg-[#3B9EE8]/10 border border-[#3B9EE8]/30 text-[#3B9EE8] font-condensed font-bold text-xs flex items-center justify-center">{step}</span>
                    <div>
                      <span className="font-condensed font-bold text-white uppercase tracking-wide text-sm">{label} — </span>
                      <span className="text-[#C4C4C4] font-body text-sm leading-relaxed">{desc}</span>
                    </div>
                  </li>
                ))}
              </ol>
            ...
            <div>
              <h2 className="font-condensed font-bold text-white uppercase tracking-wide text-xl mb-4">3. Unclaimed Products Terms</h2>
              ...
              {[
                ...
                <div key={title} className="mb-5">
                  <h3 className="font-condensed font-bold text-white uppercase tracking-wide text-sm mb-1">{title}</h3>
                  <p className="text-[#C4C4C4] font-body leading-relaxed text-sm">{body}</p>
                </div>
              ))}
            </div>
            ...
            {/* Shipping and Costs */}
            <div>
              <h2 className="font-condensed font-bold text-white uppercase tracking-wide text-xl mb-4">Shipping and Costs</h2>
              <ul className="space-y-1.5">
                {[
            ...
            {/* Contact */}
            <div>
              <h2 className="font-condensed font-bold text-white uppercase tracking-wide text-xl mb-4">Contact Us</h2>
              ...
              <p className="text-[#C4C4C4] font-body">
                Email:{' '}
                <a href="mailto:info@autobacsindia.com" className="text-[#3B9EE8] hover:text-white transition-colors">
                  info@autobacsindia.com
                </a>
              </p>
              <p className="text-[#555555] font-body text-sm mt-6">
