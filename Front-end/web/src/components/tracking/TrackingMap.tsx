      ...
      <div className="w-full bg-gray-50 rounded-lg p-6">
        <div className="flex items-start">
          ...
          <div className="ml-3 flex-1">
            <h3 className="text-sm font-medium text-gray-900">Map Unavailable</h3>
            <p className="mt-1 text-sm text-gray-600">Showing location information instead</p>
            ...
            <div className="mt-4 space-y-2">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">{destination.city}, {destination.state} {destination.postalCode}</p>
                </div>
              </div>
              ...
              {events.slice(0, 3).map((event, index) => event.location && (
                <div key={index} className="flex items-start">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">{event.status.split('_').map(w => w.charAt(0).toUpperCase() + w.slice(1)).join(' ')}</p>
  ...
  return (
    <div className="w-full">
      <div className="mb-4 flex items-center justify-between">
        ...
        <span className="text-sm text-gray-600">Via {carrierName}</span>
      </div>
