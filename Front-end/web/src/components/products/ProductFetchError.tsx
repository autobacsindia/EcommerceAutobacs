...
const ProductFetchError: React.FC<ProductFetchErrorProps> = ({ onRetry, error }) => {
  return (
    <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center max-w-2xl mx-auto">
      ...
      <p className="text-red-700 mb-4">
        We're having trouble loading products right now. This might be due to a network issue or temporary server problem.
      </p>
