...
export default function VehicleProducts({ vehicleSlug, vehicleName }: VehicleProductsProps) {
  ...
  const handleSortChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    router.push(`/vehicles/${vehicleSlug}?${currentParams.toString()}`);
  };
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold mb-2">{vehicleName} Parts & Accessories</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <nav className="text-sm text-gray-600">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-900">{vehicleName}</span>
        </nav>
      </div>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <button className="lg:hidden flex items-center gap-2 text-sm text-gray-600 bg-white px-3 py-2 rounded-md shadow-sm">
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredProducts.map((product) => (
                  ...
                  >
                    {/* Product Image */}
                    <Link href={product.permalink} className="block relative h-48 bg-gray-200">
