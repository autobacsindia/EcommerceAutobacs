...
interface VehicleModelFilterSidebarProps {
  currentVehicleSlug: string;
}

export default function VehicleModelFilterSidebar({ currentVehicleSlug }: VehicleModelFilterSidebarProps) {
      ...
      {selectedMake && selectedModel && (
        <div className="mt-4">
          <button
            ...
            className="w-full bg-gold text-obsidian py-2.5 px-4 rounded-md hover:bg-gold transition-colors flex items-center justify-center gap-2 font-medium shadow-sm"
          >
