...
export const STATIC_PAGES = [
  ...
  { path: '/affiliates', label: 'Affiliate Program', group: 'Company',
    defaultTitle: 'Affiliate Program',
    defaultDescription: 'Earn commission promoting Autobacs India. Share your link or code, your audience saves on car accessories and performance parts, and you get paid on every delivered order.' },
  { path: '/affiliates/terms', label: 'Affiliate Terms', group: 'Legal',
    defaultTitle: 'Affiliate Programme Terms',
    defaultDescription: 'The terms of the Autobacs India affiliate programme — how commission is earned and paid, the payout cycle, tax deducted at source, and how the arrangement can be ended.' },
